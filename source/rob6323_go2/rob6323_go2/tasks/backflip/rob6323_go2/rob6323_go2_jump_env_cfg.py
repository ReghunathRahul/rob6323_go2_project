"""
This configuration adapts the horizon, observation space, and reward weights for a kflip cycle.
"""
...
@configclass
class Rob6323Go2jumpEnvCfg(Rob6323Go2EnvCfg):
    """
    jump-specific tuning
    """
